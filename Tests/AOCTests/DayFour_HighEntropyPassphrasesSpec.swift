  ...
  override func spec() {
    ...
    fdescribe("part 2") {
      ...
      xit("how many are valid?") {
        ...
        let passphrases = input.split(separator: Character("\n"))
        let validPassphrases = passphrases.filter { HighEntropyPassphrases.isValidPartTwo(String($0)) }
